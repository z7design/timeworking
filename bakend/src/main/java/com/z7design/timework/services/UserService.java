...
import com.z7design.timework.dto.UserDTO;
import com.z7design.timework.dto.UserInsertDTO;
import com.z7design.timework.dto.UserUpdateDTO;
...
import com.z7design.timework.services.exceptions.EntityNotFoundException;
...
public class UserService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if( user == null ) {
			logger.error("User not foun: " + username);
